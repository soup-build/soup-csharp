...
import "mwasplund|Soup.CSharp.Compiler:./CompileArguments" for LinkTarget, NullableState
...
class RoslynArgumentBuilder {
	...
	static BuildSharedCompilerArguments(arguments) {
		...
		RoslynArgumentBuilder.AddParameter(commandArguments, "langversion", "12.0")
