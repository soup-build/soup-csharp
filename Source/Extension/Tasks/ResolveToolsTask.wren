...
class ResolveToolsTask is SoupTask {
	...
	static GetPlatformLibraries(targetingPackVersionPath) {
		...
		var platformLibraries = [
			...
			Path.new("Microsoft.Win32.Registry.dll"),
			...
			Path.new("System.Formats.Tar.dll"),
			...
			Path.new("System.IO.FileSystem.AccessControl.dll"),
			...
			Path.new("System.IO.Pipes.AccessControl.dll"),
			...
			Path.new("System.Runtime.InteropServices.JavaScript.dll"),
			...
			Path.new("System.Security.Principal.Windows.dll"),
