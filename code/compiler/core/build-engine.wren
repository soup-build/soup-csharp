...
import "./managed-compile-options" for LinkTarget
...
class BuildEngine {
	...
	Execute(options) {
		...
		this.CoreCompile(options, generatedSourceFiles, referenceDirectory, result)
	...
	/// </summary>
	CoreCompile(options, generatedSourceFiles, referenceDirectory, result) {
  ...
  \"runtimeOptions\": {
    ...
    \"configProperties\": {
      \"System.Runtime.Serialization.EnableUnsafeBinaryFormatterSerialization\": false
		...
		var frameworkAssemblyAttributesFile = options.GenerateDirectory + Path.new(".NETCoreApp,Version=v%(frameworkVersionMinor).AssemblyAttributes.cs")
		generatedSourceFiles.add(options.TargetRootDirectory + frameworkAssemblyAttributesFile)
		var frameworkAssemblyAttributesContent = "// <autogenerated />
using System;
using System.Reflection;
[assembly: global::System.Runtime.Versioning.TargetFrameworkAttribute(\".NETCoreApp,Version=v%(frameworkVersionMinor)\", FrameworkDisplayName = \".NET %(frameworkVersionMinor)\")]

"
		var writeFrameworkAssemblyAttributesFile = SharedOperations.CreateWriteFileOperation(
			options.TargetRootDirectory,
			frameworkAssemblyAttributesFile,
			frameworkAssemblyAttributesContent)
		result.BuildOperations.add(writeFrameworkAssemblyAttributesFile)

		var assemblyAttributesFile = options.GenerateDirectory + Path.new("%(options.TargetName).AssemblyInfo.cs")
		generatedSourceFiles.add(options.TargetRootDirectory + assemblyAttributesFile)
...
[assembly: System.Reflection.AssemblyCompanyAttribute(\"%(options.TargetName)\")]
[assembly: System.Reflection.AssemblyConfigurationAttribute(\"%(options.Flavor)\")]
[assembly: System.Reflection.AssemblyFileVersionAttribute(\"%(options.TargetVersion)\")]
[assembly: System.Reflection.AssemblyInformationalVersionAttribute(\"%(options.TargetVersion)+8513519b4c322896f461ecdcdb42594a66d6889a\")]
[assembly: System.Reflection.AssemblyProductAttribute(\"%(options.TargetName)\")]
[assembly: System.Reflection.AssemblyTitleAttribute(\"%(options.TargetName)\")]
[assembly: System.Reflection.AssemblyVersionAttribute(\"%(options.TargetVersion)\")]

// Generated by the MSBuild WriteCodeFragment class.

"
		var writeAssemblyAttributesFile = SharedOperations.CreateWriteFileOperation(
			options.TargetRootDirectory,
			assemblyAttributesFile,
			assemblyAttributesContent)
		result.BuildOperations.add(writeAssemblyAttributesFile)
