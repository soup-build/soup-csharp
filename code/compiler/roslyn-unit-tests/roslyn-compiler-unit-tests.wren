// <copyright file="roslyn-compiler-unit-tests.wren" company="Soup">
		...
		var expected = [
			BuildOperation.new(
				...
				[
					...
					"/unsafe- /checked- /fullpaths /nostdlib+ /errorreport:prompt /warn:4 /highentropyva+ /nullable:enable /debug+ /debug:portable /filealign:512 /optimize- /out:\"C:/target/bin/Target.dll\" /refout:\"C:/target/ref/Target.dll\" /target:library /warnaserror- /utf8output /deterministic+ /langversion:12.0 \"./File.cs\"",
				],
				[],
				[
